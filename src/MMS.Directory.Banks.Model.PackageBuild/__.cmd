...
set PROJECT_DIR=..\MMS.Directory.Banks.Model

rem Название файла Проекта без расширения
set PROJECT_FILE_WITHOUT_EXT=MMS.Directory.Banks.Model
...
set CURRENT_DIR_FROM_PROJECT_DIR=..\MMS.Directory.Banks.Model.PackageBuild
